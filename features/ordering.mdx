---
title: "WhatsApp Ordering: How Customers Place Orders"
...
<CardGroup cols={2}>
  ...
  <Card title="Customise the Message" icon="message">
    ...
    ```js
    const mensaje = `Hola Sentidos Café Cusco,
deseo solicitar más información o
realizar un pedido del producto: ${producto}.`;
    ```
