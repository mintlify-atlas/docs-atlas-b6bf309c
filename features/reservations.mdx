---
title: "Sentidos Café MySQL Table Reservation System Setup"
sidebarTitle: "Reservations"
description: "Sentidos Café stores table reservations in MySQL with guest name, phone, date, time, party size, and preferred seating zone per booking."
---
