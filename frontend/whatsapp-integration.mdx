...
description: "Sentidos Café uses api.whatsapp.com/send deep-links for combo order buttons and a fixed floating chat widget. Set the phone number and message template."
---
