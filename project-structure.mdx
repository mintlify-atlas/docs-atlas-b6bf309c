---
title: "Sentidos Café Project File Structure"
sidebarTitle: "Structure"
description: "Explore the files and directories that make up the Sentidos Café website, from PHP templates to CSS styles and the MySQL schema."
---
